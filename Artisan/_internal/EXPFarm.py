...
check_interval = timedelta(minutes=40)
recognized_count = 0
...
def start_apex_legends():
    try:
        # Replace 'path_to_apex_launcher.exe' with the actual path to the Apex Legends launcher executable
        os.startfile(r"C:\Program Files (x86)\Steam\steamapps\common\Apex Legends\r5apex.exe")
